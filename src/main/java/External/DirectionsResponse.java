...
public class DirectionsResponse {
    ...
    public DirectionsResponse(String json) {
        ...
        jsonObjectResult = jsonObject.getAsJsonArray("routes").get(0).getAsJsonObject().getAsJsonArray("legs").get(0).getAsJsonObject();
    }
...
/*    public long getDroneDistance() {
        String droneDistance = jsonObjectResult.getAsJsonObject("distance").get("value").getAsString();
        long droneDistanceValue = Long.parseLong(droneDistance);
        return droneDistanceValue;
    }*/

    // Method for getting droneDistance (Approximately)
    public double getDroneDistance() {
        double startLat = Double.parseDouble(jsonObjectResult.getAsJsonObject("start_location").get("lat").getAsString());
        double startLng = Double.parseDouble(jsonObjectResult.getAsJsonObject("start_location").get("lng").getAsString());

        double endLat = Double.parseDouble(jsonObjectResult.getAsJsonObject("end_location").get("lat").getAsString());
        double endLng = Double.parseDouble(jsonObjectResult.getAsJsonObject("end_location").get("lng").getAsString());
